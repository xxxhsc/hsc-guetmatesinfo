...
jQuery(document).ready(function() {
    ...
    //resetPwd resetPwd-popup login-popup
    $('#resetPwd').click(function(){
        $('.resetPwd-popup-wrapper').fadeIn('slow',function(){
            $(this).children('#resetPwd-popup').fadeIn('fast');
        });
    ...
    $('.close').click(function(){
        $(this).parents('.resetPwd-popup-wrapper').fadeOut('slow');
        $(this).parent('#resetPwd-popup').fadeOut('slow');
    });
    ...
    $('#signup-link').click(function(){
        $(this).parents('.login-popup-wrapper').fadeOut('fast');
        $(this).parent('#login-popup').fadeOut('fast');
        $('.signin signup popup-in pop-up').fadeIn('slow',function(){
            $(this).children('.signin signup popup-in pop-up').fadeIn('fast');
        });
    });
